...
export const ruTexts: I18nTexts = {
  ...
  anonymous: {
    ...
    wallActive: (topic: string, link: string) =>
      ...
      `2. Отправьте мне сообщение в личку\n` +
      `3. Я опубликую его в группе анонимно\n\n` +
      `👉 <a href="${link}">Открыть личку и написать анонимно</a>\n\n` +
      `⚠️ Сообщения, отправленные прямо в группу, <b>не анонимны</b>.\nОтправьте /quit, чтобы закрыть стену.`,
